...
function hiddenPs(command: string): string {
  // Run task payload in a hidden PowerShell host to prevent console flashes.
  return `powershell -NoProfile -WindowStyle Hidden -Command "Set-Location -LiteralPath '${INSTALL_DIR}'; ${command}"`;
}
...
const TASKS = [
  {
    ...
    tr: hiddenPs(`npx tsx src/agent/runner.ts >> '${LOG_DIR}\\agent.log' 2>&1`),
  ...
  },
  {
    ...
    tr: hiddenPs(`npx tsx src/agent/telegram-listener.ts >> '${LOG_DIR}\\agent-listen.log' 2>&1`),
  ...
  },
  {
    ...
    tr: hiddenPs(`npx tsx src/agent/runner-sunday.ts >> '${LOG_DIR}\\agent-sunday.log' 2>&1`),
  ...
  },
  {
    ...
    tr: hiddenPs(`npx tsx src/agent/runner-friday.ts >> '${LOG_DIR}\\agent-friday.log' 2>&1`),
  ...
  },
  {
    ...
    tr: hiddenPs(`npm run divergence >> '${LOG_DIR}\\divergence.log' 2>&1`),
  ...
  },
  {
    ...
    tr: hiddenPs(`& '${INSTALL_DIR}\\scripts\\cleanup.bat'`),
  ...
  },
  {
    ...
    tr: hiddenPs(`& '${INSTALL_DIR}\\scripts\\watchdog.bat'`),
  ...
  },
  {
    ...
    tr: hiddenPs(`npm run watchdog:independent >> '${LOG_DIR}\\watchdog-independent.log' 2>&1`),
